...
JVMFLAGS="-Dzookeeper.sessionRequireClientSASLAuth=true -Djava.security.auth.login.config=/opt/apache-zookeeper-3.8.2-bin/conf/jaas.conf -Dzookeeper.allowSaslFailedClients=true"
